...
def menu_display
	while (true)
		puts "Bonjour! Choisissez l'option que vous desirer :"
...
def count_total_journalists
	puts "Nombre total de journalistes : #{$list.length}"
end
...
def count_names_with_number
	...
	puts "Il y a #{count} comptes dont le nom contient un chiffre."
end
